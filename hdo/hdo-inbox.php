    ...
    $('#sidebar_cases').click(function() {
            $.ajax({
                ...
                data: {
                    ...
                    actiondone: 'HDO Inbox - Viewed Cases'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_apprehend').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'HDO Inbox - Viewed Apprehend'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_reports').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'HDO Inbox - Viewed Incidet Reports'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_files').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'HDO Inbox - Viewed Files'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_calendar').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'HDO Inbox - Viewed Calendar'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_inbox').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'HDO Inbox - Viewed Inbox'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_migration').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'HDO Inbox - Viewed Data Migration'
                },
                success: function(response) {
                  console.log('Success');
                }
