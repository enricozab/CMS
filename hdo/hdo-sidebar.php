	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li>
					<a href="hdo-home.php" id="sidebar_cases"><i class="fa fa-briefcase fa-fw"></i> Cases <span id="cn" class="badge"></span></a>
				</li>
				<li>
					<a href="hdo-incident-reports.php" id="sidebar_reports"><i class="fa fa-file-text-o fa-fw"></i> Incident Reports <span id="ir" class="badge"></span></a>
				</li>
				<li>
