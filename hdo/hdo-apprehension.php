    ...
    $(document).ready(function() {
            ...
            success: function(response) {
              ...
              $.ajax({
                        ...
                        data: {
                            ...
                            actiondone: 'HDO Apprehend - Apprehended a Student'
                        },
                        success: function(response) {
                          console.log('Success');
                        }
      ...
      $('#sidebar_cases').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'HDO Apprehend - Viewed Cases'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_apprehend').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'HDO Apprehend - Viewed Apprehend'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_reports').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'HDO Apprehend - Viewed Incidet Reports'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_files').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'HDO Apprehend - Viewed Files'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_calendar').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'HDO Apprehend - Viewed Calendar'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_inbox').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'HDO Apprehend - Viewed Inbox'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_migration').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'HDO Apprehend - Viewed Data Migration'
            },
            success: function(response) {
              console.log('Success');
            }
