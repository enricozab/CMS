  ...
  $(document).ready(function() {
    ...
    $('#sidebar_cases').click(function() {
      $.ajax({
          ...
          data: {
              ...
              actiondone: 'Faculty Calendar - Viewed Cases'
          },
          success: function(response) {
            console.log('Success');
          }
    ...
    $('#sidebar_report').click(function() {
      $.ajax({
          ...
          data: {
              userid: <?php echo $_SESSION['user_id'] ?>,
              actiondone: 'Faculty Calendar - Viewed Report Student'
          },
          success: function(response) {
            console.log('Success');
          }
    ...
    $('#sidebar_calendar').click(function() {
      $.ajax({
          ...
          data: {
              userid: <?php echo $_SESSION['user_id'] ?>,
              actiondone: 'Faculty Calendar - Viewed Calendar'
          },
          success: function(response) {
            console.log('Success');
          }
    ...
    $('#sidebar_inbox').click(function() {
      $.ajax({
          ...
          data: {
              userid: <?php echo $_SESSION['user_id'] ?>,
              actiondone: 'Faculty Calendar - Viewed Inbox'
          },
          success: function(response) {
            console.log('Success');
          }
