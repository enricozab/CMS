<?php
  ...
  $query='SELECT 		C.CASE_ID AS CASE_ID,
          ...
          WHERE       S.DESCRIPTION = "CLOSED" OR S.DESCRIPTION = "DISMISSED"
  ...
  if(!$result){
    ...
    while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
      ...
      //changed part
      echo "<tr onmouseover=\"this.style.cursor='pointer'\" onclick=\"location.href='sdfod-view-case.php?cn={$row['CASE_ID']}'; viewCaseAudit({$row['CASE_ID']});\">
            <td>{$row['CASE_ID']}";
