<?php
  ...
  if(!$result){
    ...
    while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
      ...
      echo "<tr onmouseover=\"this.style.cursor='pointer'\" onclick=\"location.href='sdfod-view-incident-report.php?irn={$row['INCIDENT_REPORT_ID']}'; viewIRAudit({$row['INCIDENT_REPORT_ID']});\">
