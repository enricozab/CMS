    ...
    $('#sidebar_cases').click(function() {
            $.ajax({
                ...
                data: {
                    ...
                    actiondone: 'IDO Inbox - Viewed Cases'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_report').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'IDO Inbox - Viewed Report Student'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_files').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'IDO Inbox - Viewed Files'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_calendar').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'IDO Inbox - Viewed Calendar'
                },
                success: function(response) {
                  console.log('Success');
                }
          ...
          $('#sidebar_inbox').click(function() {
            $.ajax({
                ...
                data: {
                    userid: <?php echo $_SESSION['user_id'] ?>,
                    actiondone: 'IDO Inbox - Viewed Inbox'
                },
                success: function(response) {
                  console.log('Success');
                }
