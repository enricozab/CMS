...
<body>
  ...
  $(document).ready(function() {
    ...
    $('#sidebar_dashboard').click(function() {
      $.ajax({
          ...
          data: {
              ...
              actiondone: 'SDFOD Inbox - Viewed Dashboard'
          },
          success: function(response) {
            console.log('Success');
          }
    ...
    $('#sidebar_cases').click(function() {
      $.ajax({
          ...
          data: {
              userid: <?php echo $_SESSION['user_id'] ?>,
              actiondone: 'SDFOD Inbox - Viewed Cases'
          },
          success: function(response) {
            console.log('Success');
          }
    ...
    $('#sidebar_calendar').click(function() {
      $.ajax({
          ...
          data: {
              userid: <?php echo $_SESSION['user_id'] ?>,
              actiondone: 'SDFOD Inbox - Viewed Calendar'
          },
          success: function(response) {
            console.log('Success');
          }
    ...
    $('#sidebar_drive').click(function() {
      $.ajax({
          ...
          data: {
              userid: <?php echo $_SESSION['user_id'] ?>,
              actiondone: 'SDFOD Inbox - Viewed Files'
          },
          success: function(response) {
            console.log('Success');
          }
    ...
    $('#sidebar_inbox').click(function() {
      $.ajax({
          ...
          data: {
              userid: <?php echo $_SESSION['user_id'] ?>,
              actiondone: 'SDFOD Inbox - Viewed Inbox'
          },
          success: function(response) {
            console.log('Success');
          }
    ...
    $('#sidebar_sysmanagement').click(function() {
      $.ajax({
          ...
          data: {
              userid: <?php echo $_SESSION['user_id'] ?>,
              actiondone: 'SDFOD Inbox - Viewed System Management'
          },
          success: function(response) {
            console.log('Success');
          }
    ...
    $.ajax({
        ...
        data: {
            userid: <?php echo $_SESSION['user_id'] ?>,
            actiondone: 'SDFOD Inbox - Viewed System Audit'
        },
        success: function(response) {
          console.log('Success');
        }
  ...
  $('#sidebar_reports').click(function() {
    $.ajax({
        ...
        data: {
            userid: <?php echo $_SESSION['user_id'] ?>,
            actiondone: 'SDFOD Inbox - Viewed Incident Reports'
        },
        success: function(response) {
          console.log('Success');
        }
