<button id="compose-button" class="btn btn-primary pull-left hidden" onclick="compose()">Compose</button>
...
<div class="modal" id="compose-modal" tabindex="-1" role="dialog">
...
<script type="text/javascript">
  ...
  function appendMessageRow(message) {
    ...
    $('body').append(
      '<div class="modal" id="message-modal-' + message.id +
