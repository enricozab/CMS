      ...
      function viewCaseAudit(x) {
        $.ajax({
            ...
            data: {
                ...
                actiondone: ('AULC Cases - Viewed Case #' + x)
            },
...
<!-- Page-Level Demo Scripts - Tables - Use for reference -->
  ...
  $(document).ready(function() {
    ...
    function normalTable() {
      $.ajax({
        url: '../ajax/aulc-get-cases-priority.php',
        type: 'POST',
        data: {
        },
        success: function(response) {
    ...
    $('#open').on('click', function () {
      ...
      function activeTable() {
        $.ajax({
          url: '../ajax/aulc-get-cases-active.php',
          type: 'POST',
          data: {
          },
          success: function(response) {
    ...
    $('#closed').on('click', function () {
      ...
      function closedTable() {
        $.ajax({
          url: '../ajax/aulc-get-cases-closed.php',
          type: 'POST',
          data: {
          },
          success: function(response) {
    ...
    $('#sidebar_cases').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'AULC Cases - Viewed Cases'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_files').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'AULC Cases - Viewed Files'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_calendar').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'AULC Cases - Viewed Calendar'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_inbox').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'AULC Cases - Viewed Inbox'
            },
            success: function(response) {
              console.log('Success');
            }
