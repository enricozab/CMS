    ...
    $('#sidebar_cases').click(function() {
        $.ajax({
            ...
            data: {
                ...
                actiondone: 'AULC Calendar - Viewed Cases'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_files').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'AULC Calendar - Viewed Files'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_calendar').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'AULC Calendar - Viewed Calendar'
            },
            success: function(response) {
              console.log('Success');
            }
      ...
      $('#sidebar_inbox').click(function() {
        $.ajax({
            ...
            data: {
                userid: <?php echo $_SESSION['user_id'] ?>,
                actiondone: 'AULC Calendar - Viewed Inbox'
            },
            success: function(response) {
              console.log('Success');
            }
